...
# Get resource
site_name = 'Kings Bay'
if site_name == 'Kings Bay':
    lat = 30.781667  #flatirons_site['lat'] Fort Stewart 31.871877704660903, -81.60586505672431 NSA Midsouth: 35.34355619446375, -89.86043402607109
    lon = -81.535  #flatirons_site
...
kw_continuous = 15000 # Peak Load expected
...
for critical_load_factor in critical_load_factor_list:
    for i, scenario in scenarios_df.iterrows():
        ...
        reopt.post['Scenario']['Site']['Storage'] = {'min_kw': 0.0, 'max_kw': 10000.0, 'min_kwh': 0.0, 'max_kwh': 40000000.0,
