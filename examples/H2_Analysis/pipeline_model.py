...
class Pipeline: 
    ...
    def pipeline_cost(self):
        """
        Determines pipeline cost using distance from h2 to load, flow rate, plant life, and choice of pipeline model
        Includes both NRWAL pipeline model and (NREL and Nexant) H2A Report DE-FG36-05GO15032 model
        """
        ...
        if self.pipeline_model == 'nrwl': 
            ...
            capex_pipe = install_capex_fact * capex_pipe 
        ...
        return capex_pipe, opex_pipe, pipeline_annuals
