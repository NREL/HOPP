...
def simple_dispatch(combined_pv_wind_curtailment_hopp,energy_shortfall_hopp,N):
    ...
    return battery_used, excess_energy, battery_generation

battery_used, excess_energy, battery_generation = simple_dispatch(combined_pv_wind_curtailment_hopp,energy_shortfall_hopp,N)
