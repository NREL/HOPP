...
def test_ammonia_cost_model(subtests):
    ...
    res: ammonia.AmmoniaCostModelOutputs = ammonia.run_ammonia_costs(config)
...
def test_ammonia_finance_model():
    ...
    costs: ammonia.AmmoniaCostModelOutputs = ammonia.run_ammonia_costs(cost_config)

    plant_capacity_kgpy = 362560672.27155423
    plant_capacity_factor = 0.9

    ammonia_production_kgpy = ammonia.run_ammonia_model(plant_capacity_kgpy,plant_capacity_factor)
    ...
    config = ammonia.AmmoniaFinanceModelConfig(
        ...
        grid_prices={'2035': 89.42320514456621, '2036': 89.97947569251141, '2037': 90.53574624045662, '2038': 91.09201678840184, '2039': 91.64828733634704, '2040': 92.20455788429224, '2041': 89.87291235917809, '2042': 87.54126683406393, '2043': 85.20962130894978, '2044': 82.87797578383562, '2045': 80.54633025872147, '2046': 81.38632144593608, '2047': 82.22631263315068, '2048': 83.0663038203653, '2049': 83.90629500757991, '2050': 84.74628619479452, '2051': 84.74628619479452, '2052': 84.74628619479452, '2053': 84.74628619479452, '2054': 84.74628619479452, '2055': 84.74628619479452, '2056': 84.74628619479452, '2057': 84.74628619479452, '2058': 84.74628619479452, '2059': 84.74628619479452, '2060': 84.74628619479452, '2061': 84.74628619479452, '2062': 84.74628619479452, '2063': 84.74628619479452, '2064': 84.74628619479452},
    ...
    res: ammonia.AmmoniaFinanceModelOutputs = ammonia.run_ammonia_finance(config)
