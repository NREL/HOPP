...
class REopt:
    ...
    def __init__(self, lat, lon,
        ...
        *_model: PySAM models
        ...
        self.reopt_api_post_url = 'https://offgrid-electrolyzer-reopt-dev-api.its.nrel.gov/v1/job/<run_uuid>/results/' #'https://developer.nrel.gov/api/reopt/v1/job?format=json'
        self.reopt_api_poll_url = 'https://offgrid-electrolyzer-reopt-dev-api.its.nrel.gov/v1/job/<run_uuid>/results/' #'https://developer.nrel.gov/api/reopt/v1/job/'
    ...
    def get_reopt_results(self, post, API_KEY, api_url, results_file='results.json', run_id=None):
        """
        ...
        if run_id is None:
            run_id = self.get_run_uuid(post, API_KEY=API_KEY, api_url=api_url)
