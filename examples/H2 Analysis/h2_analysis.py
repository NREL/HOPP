...
atb_year_list = [2020, 2025, 2030, 2035]  #, 2025, 2030, 'Custom']  # Will determine cost
#TODO Remove after 3 bar analysis
three_scenario = True
three_scenario_list = ['No Help', 'Policy Help', 'Policy Help + Aggressive Tech Innovation']
            ...
            for ptc_avail in ptc_avail_list:
                for itc_avail in itc_avail_list:
                    for tower_height in tower_height_list:
                        ...
                        if three_scenario:
                            for scenario_choice in three_scenario_list:
