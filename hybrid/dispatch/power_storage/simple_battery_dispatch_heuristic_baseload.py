...
class SimpleBatteryBaseloadDispatchHeuristic(SimpleBatteryDispatch):
    ...
    def _heuristic_method(self, gen, goal_power):
        ...
        self._enforce_power_fraction_limits(gen, goal_power)

    def _enforce_power_fraction_limits(self, gen, goal_power):
