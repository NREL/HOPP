...
from optimization.optimizer.CEM_optimizer import CEMOptimizer
...
class WindOptBGMD_CEM(ConvertingOptimizationDriver):
    ...
    def __init__(self,
        ...
        prior = problem.generate_prior(GaussianDimension, callback_three=lambda: prior_scale)
        ...
        optimizer = CEMOptimizer(generation_size, selection_proportion) if optimizer is None else optimizer
        super().__init__(
