...
# dircambium = os.path.join(os.path.split(__file__)[0], "probably_to_project", "H2_Analysis", "Cambium_data", "StdScen21_MidCase95by2035_hourly_")
...
def hydrogen_LCA_singlescenario_ProFAST(grid_connection_scenario,atb_year,site_name,policy_option,hydrogen_production_while_running,H2_Results,electrolyzer_energy_kWh_per_kg,solar_size_mw,storage_size_mw,hopp_dict):
    ...
    dircambium = os.path.join(
        hopp_dict.main_dict['Configuration']['parent_path'],
        "H2_Analysis",
        "Cambium_data",
        "StdScen21_MidCase95by2035_hourly_",
    )
