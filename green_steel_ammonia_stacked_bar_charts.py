...
for electrolysis_case in electrolysis_cases:
    for grid_case in grid_cases:
        ...
        for site in locations:
            ...
            ax.bar(labels,storage_compression_cost[site], width, label='Storage & compression')
            barbottom=storage_compression_cost[site]
            #ax.bar(labels,compression_cost,width,bottom=storage_cost,label = 'Compression')
            ax.bar(labels,elec_cap_cost[site],width,bottom=barbottom,label = 'Electrolyzer CAPEX')
            barbottom=barbottom+elec_cap_cost[site]
            ax.bar(labels,elec_FOM[site],width,bottom = barbottom,label = 'Electrolyzer FOM')
            barbottom=barbottom+elec_FOM[site]
            ax.bar(labels,elec_VOM[site],width,bottom=barbottom,label = 'Electrolyzer VOM')
            barbottom=barbottom+elec_VOM[site]
            ax.bar(labels,desal_and_water[site],width,bottom=barbottom,label='Desalination and water')
            barbottom=barbottom+desal_and_water[site]
            ax.bar(labels,bulk_transmission[site],width,bottom=barbottom,label='Bulk H2 Transmission')
            barbottom = barbottom+bulk_transmission[site]
            ax.bar(labels,taxes_and_financial[site],width,bottom=barbottom,label = 'Taxes and Finances')
            ...
            if grid_case == 'off-grid' or grid_case == 'hybrid-grid-retail-flat' or grid_case =='hybrid-grid-retail-peaks':
                ax.bar(labels,renew_cap_cost[site],width,bottom=barbottom,label = 'Renewable CAPEX')
                barbottom=barbottom+renew_cap_cost[site]
                ax.bar(labels,renew_FOM[site],width,bottom=barbottom,label = 'Renewable FOM')
            ...
            if grid_case == 'grid-only-retail-flat' or grid_case =='grid-only-retail-peaks' or grid_case == 'hybrid-grid-retail-flat' or grid_case =='hybrid-grid-retail-peaks':
                ax.bar(labels,grid_electricity[site],width,bottom=barbottom,label = 'Grid Electricity',color='y')
        ...
        # Top left
        ax[0,0].bar(labels,storage_compression_cost['IN'], width, label='Storage & compression')
        barbottom=storage_compression_cost['IN']
        ax[0,0].bar(labels,elec_cap_cost['IN'],width,bottom=barbottom,label = 'Electrolyzer CAPEX')
        barbottom=barbottom+elec_cap_cost['IN']
        ax[0,0].bar(labels,elec_FOM['IN'],width,bottom = barbottom,label = 'Electrolyzer FOM')
        barbottom=barbottom+elec_FOM['IN']
        ax[0,0].bar(labels,elec_VOM['IN'],width,bottom=barbottom,label = 'Electrolyzer VOM')
        barbottom=barbottom+elec_VOM['IN']
        ax[0,0].bar(labels,desal_and_water['IN'],width,bottom=barbottom,label='Desalination and water')
        barbottom=barbottom+desal_and_water['IN']
        ax[0,0].bar(labels,bulk_transmission['IN'],width,bottom=barbottom,label='Bulk H2 Transmission')
        barbottom = barbottom+bulk_transmission['IN']
        ax[0,0].bar(labels,taxes_and_financial['IN'],width,bottom=barbottom,label = 'Taxes and Finances')
        barbottom=barbottom+taxes_and_financial['IN']
        if grid_case == 'off-grid' or grid_case == 'hybrid-grid-retail-flat' or grid_case =='hybrid-grid-retail-peaks':
            ax[0,0].bar(labels,renew_cap_cost['IN'],width,bottom=barbottom,label = 'Renewable CAPEX')
            barbottom=barbottom+renew_cap_cost['IN']
            ax[0,0].bar(labels,renew_FOM['IN'],width,bottom=barbottom,label = 'Renewable FOM')
            barbottom=barbottom+renew_FOM['IN']
        if grid_case == 'grid-only-retail-flat' or grid_case =='grid-only-retail-peaks' or grid_case == 'hybrid-grid-retail-flat' or grid_case =='hybrid-grid-retail-peaks':
            ax[0,0].bar(labels,grid_electricity['IN'],width,bottom=barbottom,label = 'Grid Electricity',color='y')
        ...
        # Top right
        ax[0,1].bar(labels,storage_compression_cost['IA'], width, label='Storage & compression')
        barbottom=storage_compression_cost['IA']
        ax[0,1].bar(labels,elec_cap_cost['IA'],width,bottom=barbottom,label = 'Electrolyzer CAPEX')
        barbottom=barbottom+elec_cap_cost['IA']
        ax[0,1].bar(labels,elec_FOM['IA'],width,bottom = barbottom,label = 'Electrolyzer FOM')
        barbottom=barbottom+elec_FOM['IA']
        ax[0,1].bar(labels,elec_VOM['IA'],width,bottom=barbottom,label = 'Electrolyzer VOM')
        barbottom=barbottom+elec_VOM['IA']
        ax[0,1].bar(labels,desal_and_water['IA'],width,bottom=barbottom,label='Desalination and water')
        barbottom=barbottom+desal_and_water['IA']
        ax[0,1].bar(labels,bulk_transmission['IA'],width,bottom=barbottom,label='Bulk H2 Transmission')
        barbottom = barbottom+bulk_transmission['IA']
        ax[0,1].bar(labels,taxes_and_financial['IA'],width,bottom=barbottom,label = 'Taxes and Finances')
        barbottom=barbottom+taxes_and_financial['IA']
        if grid_case == 'off-grid' or grid_case == 'hybrid-grid-retail-flat' or grid_case =='hybrid-grid-retail-peaks':
            ax[0,1].bar(labels,renew_cap_cost['IA'],width,bottom=barbottom,label = 'Renewable CAPEX')
            barbottom=barbottom+renew_cap_cost['IA']
            ax[0,1].bar(labels,renew_FOM['IA'],width,bottom=barbottom,label = 'Renewable FOM')
            barbottom=barbottom+renew_FOM['IA']
        if grid_case == 'grid-only-retail-flat' or grid_case =='grid-only-retail-peaks' or grid_case == 'hybrid-grid-retail-flat' or grid_case =='hybrid-grid-retail-peaks':
            ax[0,1].bar(labels,grid_electricity['IA'],width,bottom=barbottom,label = 'Grid Electricity',color='y')
        ...
        # Bottom left
        ax[1,0].bar(labels,storage_compression_cost['TX'], width, label='Storage & compression')
        barbottom=storage_compression_cost['TX']
        ax[1,0].bar(labels,elec_cap_cost['TX'],width,bottom=barbottom,label = 'Electrolyzer CAPEX')
        barbottom=barbottom+elec_cap_cost['TX']
        ax[1,0].bar(labels,elec_FOM['TX'],width,bottom = barbottom,label = 'Electrolyzer FOM')
        barbottom=barbottom+elec_FOM['TX']
        ax[1,0].bar(labels,elec_VOM['TX'],width,bottom=barbottom,label = 'Electrolyzer VOM')
        barbottom=barbottom+elec_VOM['TX']
        ax[1,0].bar(labels,desal_and_water['TX'],width,bottom=barbottom,label='Desalination and water')
        barbottom=barbottom+desal_and_water['TX']
        ax[1,0].bar(labels,bulk_transmission['TX'],width,bottom=barbottom,label='Bulk H2 Transmission')
        barbottom = barbottom+bulk_transmission['TX']
        ax[1,0].bar(labels,taxes_and_financial['TX'],width,bottom=barbottom,label = 'Taxes and Finances')
        barbottom=barbottom+taxes_and_financial['TX']
        if grid_case == 'off-grid' or grid_case == 'hybrid-grid-retail-flat' or grid_case =='hybrid-grid-retail-peaks':
            ax[1,0].bar(labels,renew_cap_cost['TX'],width,bottom=barbottom,label = 'Renewable CAPEX')
            barbottom=barbottom+renew_cap_cost['TX']
            ax[1,0].bar(labels,renew_FOM['TX'],width,bottom=barbottom,label = 'Renewable FOM')
            barbottom=barbottom+renew_FOM['TX']
        if grid_case == 'grid-only-retail-flat' or grid_case =='grid-only-retail-peaks' or grid_case == 'hybrid-grid-retail-flat' or grid_case =='hybrid-grid-retail-peaks':
            ax[1,0].bar(labels,grid_electricity['TX'],width,bottom=barbottom,label = 'Grid Electricity',color='y')
        ...
        # Bottom right
        ax[1,1].bar(labels,storage_compression_cost['MS'], width, label='Storage & compression')
        barbottom=storage_compression_cost['MS']
        ax[1,1].bar(labels,elec_cap_cost['MS'],width,bottom=barbottom,label = 'Electrolyzer CAPEX')
        barbottom=barbottom+elec_cap_cost['MS']
        ax[1,1].bar(labels,elec_FOM['MS'],width,bottom = barbottom,label = 'Electrolyzer FOM')
        barbottom=barbottom+elec_FOM['MS']
        ax[1,1].bar(labels,elec_VOM['MS'],width,bottom=barbottom,label = 'Electrolyzer VOM')
        barbottom=barbottom+elec_VOM['MS']
        ax[1,1].bar(labels,desal_and_water['MS'],width,bottom=barbottom,label='Desalination and water')
        barbottom=barbottom+desal_and_water['MS']
        ax[1,1].bar(labels,bulk_transmission['MS'],width,bottom=barbottom,label='Bulk H2 Transmission')
        barbottom = barbottom+bulk_transmission['MS']
        ax[1,1].bar(labels,taxes_and_financial['MS'],width,bottom=barbottom,label = 'Taxes and Finances')
        barbottom=barbottom+taxes_and_financial['MS']
        if grid_case == 'off-grid' or grid_case == 'hybrid-grid-retail-flat' or grid_case =='hybrid-grid-retail-peaks':
            ax[1,1].bar(labels,renew_cap_cost['MS'],width,bottom=barbottom,label = 'Renewable CAPEX')
            barbottom=barbottom+renew_cap_cost['MS']
            ax[1,1].bar(labels,renew_FOM['MS'],width,bottom=barbottom,label = 'Renewable FOM')
            barbottom=barbottom+renew_FOM['MS']
        if grid_case == 'grid-only-retail-flat' or grid_case =='grid-only-retail-peaks' or grid_case == 'hybrid-grid-retail-flat' or grid_case =='hybrid-grid-retail-peaks':
            ax[1,1].bar(labels,grid_electricity['MS'],width,bottom=barbottom,label = 'Grid Electricity',color='y')
