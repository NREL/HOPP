...
for critical_load_factor in critical_load_factor_list:
    for i, scenario in scenarios_df.iterrows():
        ...
        kw_continuous = 5000 # 5 MW continuous load - equivalent to 909kg H2 per hr at 55 kWh/kg electrical intensity
        ...
        print("Peak Production Rate for H2 Electrolyzer {}".format(results['peak_production_rate']))
