...
def run_profast_grid_only(plant_config, orbit_project, electrolyzer_physics_results, capex_breakdown, opex_breakdown, hopp_results, design_scenario, verbose=False, show_plots=False, save_plots=False):
    ...
    pf.add_feedstock(name='Water', usage=electrolyzer_physics_results["H2_Results"]['water_annual_usage']*galperkg/electrolyzer_physics_results["H2_Results"]['hydrogen_annual_output'],unit='gal', cost='US Average', escalation=gen_inflation)
