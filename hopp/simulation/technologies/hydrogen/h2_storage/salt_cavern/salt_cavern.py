...
if __name__ == '__main__':
    ...
    test = Salt_Cavern_Storage(in_dict)
    capex_per_kg, installed_capex, comp_capex = test.salt_cavern_capex()
    test.salt_cavern_opex()
    print('Salt cavern storage capex [USD]: ', test.output_dict['salt_cavern_storage_capex'])
    print('Salt cavern storage opex [USD/yr]: ', test.output_dict['salt_cavern_storage_opex'])
