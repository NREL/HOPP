...
def site_details_creator(desired_lats, desired_lons, year="2012"):
    """
    Creates a "site_details" dataframe containing a list of sites with desired_lats, desired_lons
    :param desired_lats: Desired Latitudes
    :param desired_lons: Desired Longitudes
    :param year: Year chosen for site data
    :return: site_details Dataframe of site_num, Lat, Lon, solar_filenames, wind_filenames, year
    """
    ...
    site_details['solar_filenames'] = solar_filenames
    site_details['wind_filenames'] = wind_filenames
    site_details['year'] = years
