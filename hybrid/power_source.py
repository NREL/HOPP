...
class PowerSource:
    ...
    def simulate_powerflow(self, project_life: int = 25):
        if self.name == 'WindPlant':
            ...
            # power_flow_grid_model.add_connections([['G', 'T1'], ['T1', 'T2'], ['T2', 'T15'], ['T15', 'T16']], cable1,
            #                                       length_method='direct')

            # power_flow_grid_model.add_connections([['G', 'T1'], ['T1', 'T2'], ['T2', 'T3'], ['T3', 'T4'],
            #                                        ['T4', 'T5'], ['T5', 'T6'], ['T6', 'T7'], ['T7', 'T8'], ['T8', 'T9'],
            #                                        ['T9', 'T10'], ['T10', 'T11'], ['T11', 'T12'], ['T12', 'T13'],
            #                                        ['T13', 'T14'], ['T14', 'T15'], ['T15', 'T16']], cable1,
            #                                       length_method='direct')
            ...
            for gen_at_time in turb_gen:
                ...
                if gen_at_time > 0:
                    ...
                    # P_turbs = [[gen_at_time+(gen_at_time*0.01e1j)] * self.wind.num_turbines]
                    P_turbs = np.array(P_turbs)
                    # P_turbs = P_turbs.transpose()
